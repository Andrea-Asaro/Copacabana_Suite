...
export default function Footer(){
    ...
    return(
        ...
        <div className="container-fluid px-5 bg2" id='footer'>
            <footer className="row row-cols-1 row-cols-sm-2 row-cols-lg-4 py-lg-5 py-4 my-3 px-lg-5 font2">
                ...
                <div className="col mb-4 mb-lg-2">
                    ...
                    <ul className="nav flex-column">
                        ...
                        <li className="nav-item mb-3">
                            <NavLink to="/contattiPage" className="nav-link p-0 text3 fs-6 ">Contatti</NavLink>
                        </li>
                        <li className="nav-item mb-3">

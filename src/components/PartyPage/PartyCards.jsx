            ...
            <div className="row px-5">
                <div className="col-12 col-lg-4 my-4">
                    ...
                    <div className="card rounded-0 bg0 h-100">
                        <img src="https://picsum.photos/id/1015/400/300" className="card-img-top rounded-0" alt="18esimo compleanno sulla spiaggia"/>
                ...
                <div className="col-12 col-lg-4 my-4">
                    ...
                    <div className="card rounded-0 bg0 h-100">
                        <img src="https://picsum.photos/id/1016/400/300" className="card-img-top rounded-0" alt="Ricevimento elegante al tramonto"/>
                        <div className="card-body p-4">
                ...
                <div className="col-12 col-lg-4 my-4">
                    ...
                    <div className="card rounded-0 bg0 h-100">
                        <img src="https://picsum.photos/id/1019/400/300" className="card-img-top rounded-0" alt="Anniversario di matrimonio in riva al mare"/>
                        <div className="card-body p-4">

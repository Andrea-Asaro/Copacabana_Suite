        ...
        <div className="container-fluid p-lg-5 py-5 mt-5 bg0">
            <div className="row px-5">
                <div className="col-12 col-lg-6 my-4">
                    <div className="card rounded-0 bg0 h-100 wedding-card" style={{backgroundImage: `url(${weddingImg1})`, backgroundSize: 'cover', backgroundPosition: 'center'}}>
                ...
                <div className="col-12 col-lg-6 my-4">
                    <div className="card rounded-0 bg0 h-100 wedding-card" style={{backgroundImage: `url(${weddingImg2})`, backgroundSize: 'cover', backgroundPosition: 'center'}}>
                        <div className="card-body p-4 d-flex flex-column justify-content-end" style={{backgroundColor: 'rgba(0,0,0,0.25)'}}>
